...
namespace Collections
{
    class Program
    {
        ...
        private static void ListExample()
        {
            ...
            Console.WriteLine();
            Console.WriteLine("//Collections - Extra (for home) 2.Implement the IComparable interface in the Band class.");
        ...
        private static void DictionaryExample()
        {
            ...
            {
                Console.WriteLine("Exista deja muse");
            }
            ...
            {
                Console.WriteLine("Nu exista Guta" + " Exceptie: " + ex.Message);
            }
        }
        ...
        private static IEnumerable<string> BritishBands(IEnumerable<Band> bandsList)
        {
            foreach (var band in bandsList)
            {
                if (band.Country == "England")
                    yield return band.Name;
            }
        }
